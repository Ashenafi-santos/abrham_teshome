  ...
  return (
    <div className="bg-gray-100 py-12 font-Raleway">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-extrabold text-center text-gray-900 mb-8">Our Vision</h2>
...
const VisionCard = ({ vision, index }) => {
  return (
    ...
    >
      ...
      <h3 className="text-xl font-bold text-gray-900 text-center mb-2">{vision.title}</h3>
