...
const missions = [
  ...
  {
    icon: <FiSettings className="w-8 h-8 text-secondary mx-auto" />,
  ...
  {
    icon: <FiTarget className="w-8 h-8 text-secondary mx-auto" />,
  ...
  {
    icon: <FiBookOpen className="w-8 h-8 text-secondary mx-auto" />,
  ...
  {
    icon: <FiUsers className="w-8 h-8 text-secondary mx-auto" />,
  ...
  {
    icon: <FiHeart className="w-8 h-8 text-secondary mx-auto" />,
